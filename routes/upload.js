...
const Sharp = require('sharp'); // Для внесения файлов, а именно изображений в поток node, для ресайзинга изображений
const multer = require('multer'); // Можуль для загрузки файлов из файловой системы машины
const mkdirp = require('mkdirp'); // Модуль для создания дерикторий если таковых не имеется

const config = require('../config');
const diskStorage = require('../utils/diskStorage'); // скрипт для управления потоками
